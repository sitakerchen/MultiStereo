...
#include <memory>
#include "../../CustomControls-Qt-master/CustomLineEdit/CustomLineEdit.h"
...
QT_MOC_LITERAL(15, 13), // "returnPressed"
QT_MOC_LITERAL(29, 0), // ""
QT_MOC_LITERAL(30, 11) // "textChanged"

    },
    "CustomLineEdit\0returnPressed\0\0textChanged"
};
...
void CustomLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomLineEdit::returnPressed)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CustomLineEdit::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomLineEdit::textChanged)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<CustomLineEdit, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void CustomLineEdit::returnPressed()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void CustomLineEdit::textChanged()
{
