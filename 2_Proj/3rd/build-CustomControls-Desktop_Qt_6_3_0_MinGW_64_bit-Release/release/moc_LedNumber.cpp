...
#include <memory>
#include "../../CustomControls-Qt-master/LEDNumber/LedNumber.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LEDNumber_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_LEDNumber_t qt_meta_stringdata_LEDNumber = {
    {
QT_MOC_LITERAL(0, 9) // "LEDNumber"
...
const QMetaObject LEDNumber::staticMetaObject = { {
    ...
    qt_meta_stringdata_LEDNumber.offsetsAndSize,
    qt_meta_data_LEDNumber,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LEDNumber_t
, QtPrivate::TypeAndForceComplete<LEDNumber, std::true_type>
