    ...
    , ui(new Ui::homePage)
{
    ...
    connect(m_tcpCtr, &tcpController::evoke_split6, m_MedaProces, &rawMediaProcess::split_6);
    connect(m_tcpCtr, &tcpController::evoke_getChannels, m_MedaProces, &rawMediaProcess::getFileChannels);
